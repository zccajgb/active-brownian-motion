function [poly_loc]= abm_iter2d_nobm(PDt,PDr,t,n,poly_loc,u,omega,theta_0); 
...
poly_loc(:,1:2)=poly_loc(:,1:2)+(U.*t);%iterate translational motion
poly_loc(:,4)=mod(poly_loc(:,4)+(omega'.*t),2*pi); %iterate rotation, modulo to constrain between 0 and po
